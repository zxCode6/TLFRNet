...
parser.add_argument('--dataset_dir', default='./dataset/CubBirds/', help='/miniImageNet')
parser.add_argument('--data_name', default='CubBird', help='miniImageNet|StanfordDog|StanfordCar|CubBird')
