...
data_dir = '../dataset/StanfordDogs/images'                # the path of the download dataset
save_dir = '../dataset/StanfordDogs/images'          # the saving path of the divided dataset
...
with open(os.path.join(save_dir, 'train.csv'), 'w',newline='') as csvfile:
...
with open(os.path.join(save_dir, 'val.csv'), 'w',newline='') as csvfile:
	writer = csv.writer(csvfile)
...
with open(os.path.join(save_dir, 'test.csv'), 'w',newline='') as csvfile:
	writer = csv.writer(csvfile)
