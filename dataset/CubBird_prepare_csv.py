...
data_dir = '../dataset/CubBirds/image/'                # the path of the download dataset
save_dir = '../dataset/CubBirds/data'          # the saving path of the divided dataset
...
for class_name in train_list:
	...
	for index, img_path in enumerate(img_paths):
		...
		img = img.convert('RGB')
		img.save(os.path.join(save_dir, 'data', images[index][0]), quality=100)
